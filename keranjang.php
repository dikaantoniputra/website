					...
					<form method="post">
							...
							?>
								...
								<tr class="table_row">
									...
									<td class="column-2">RP.<?php echo number_format($pecah["harga_produk"]); ?></td>
									...
									<td class="column-5"><a href="hapuskeranjang.php?id=<?php echo $id_produk ?>" class="btn btn-danger btn-xs" role="button">Delete</a></td>
									<td class="column-5"><a href="product-detail-keranjang.php?id=<?php echo $id_produk ?>" class="btn btn-info btn-xs" role="button">Lihat</a></td>
						...
						<div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
							...
							<a href="home.php" class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10">
								Lanjut Belanja
							</a>
						</div>
					</div>
